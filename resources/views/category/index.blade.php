        ...
        <div class="row mx-1">
            ...
            <div class="col-md-10">
                <div class="d-flex align-items-center justify-content-md-end justify-content-center">
                    ...
                    <div class="add-new"><button class="btn btn-primary" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasAddUser"><i class="mdi mdi-plus me-0 me-sm-1"></i><span
                                class="d-none d-sm-inline-block"> Add New User </span></button></div>
                </div>
            </div>
        </div>
                    ...
                    <td class="sorting_1">
                        <div class="d-flex justify-content-start align-items-center user-name">
                            ...
                            <div class="d-flex flex-column"><a
                                    ...
                                    class="text-heading text-truncate"><span class="fw-medium">{{ $category->name }}</span></a></div>
                        </div>
                    </td>
                    <td><span>{{ $category->is_pizza }}</span></td>


                    <td><span class="badge rounded-pill bg-label-success" text-capitalized="">{{ $category->category_status }}</span></td>
                    <td>
