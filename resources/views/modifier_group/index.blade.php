        ...
        <table class="datatables-users table dataTable no-footer dtr-column" id="DataTables_Table_0"
            ...
            <thead class="border-top table-light">
                <tr>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                        style="width: 94px;" aria-label="Status: activate to sort column ascending">Is_limit</th>
                        <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1"
                    ...
                    <td class="sorting_1">
                        <div class="d-flex justify-content-start align-items-center user-name">
                            ...
                            <div class="d-flex flex-column"><a
                                    ...
                                    class="text-heading text-truncate"><span class="fw-medium">{{ $modifierGroup->name }}</span></a></div>
                        </div>
                    </td>
                    {{-- <td><span>{{ $modifierGroups->is_pizza }}</span></td> --}}


                    <td><span class="badge rounded-pill bg-label-success" text-capitalized="">{{ $modifierGroup->is_active }}</span></td>
                    <td><span class="badge rounded-pill bg-label-success" text-capitalized="">{{ $modifierGroup->is_limit }}</span></td>
